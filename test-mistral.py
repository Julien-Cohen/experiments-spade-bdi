...
def build_messages_for_coverage (spec_descr, req_list):
    ...
    {
        "role": "user",
        "content": "Specification: " + spec_descr + "(end of the specification) List of requirements: " + req_list + "(end of list of requirements).",
    }]

chat_response = client.chat.complete(
    model = model,
    messages =
        build_messages_for_coverage("A software that compares two words.", "* It takes two words as parameters."),
    max_tokens=2
